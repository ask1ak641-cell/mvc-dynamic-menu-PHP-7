...
<div class="content">
    <div class="container-fluid">
        <form method="POST" action="<?= URL::base('/menu/edit/' . $row['id']) ?>">
            <?= Security::csrfField() ?>
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header"><h3 class="card-title"><i class="fas fa-edit mr-2"></i>Form Edit Menu</h3></div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" required
                                               value="<?= htmlspecialchars($row['name']) ?>" autofocus>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="parent_id" class="form-control select2">
                                            ...
                                            <?php if ($p['id'] != $row['id']): ?>
                                            <option value="<?= $p['id'] ?>" <?= $p['id'] == $row['parent_id'] ? 'selected' : '' ?>><?= htmlspecialchars($p['name']) ?></option>
                                            <?php endif; ?>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>Urutan</label>
                                        <input type="number" name="sort_order" class="form-control" value="<?= $row['sort_order'] ?>" min="0">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="pt-1">
                                            <label class="switch-toggle">
                                                <input type="checkbox" name="is_active" value="1" <?= $row['is_active'] ? 'checked' : '' ?> class="toggle-input">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header bg-light">
                            <h3 class="card-title"><i class="fas fa-info-circle mr-2"></i>Info Menu</h3>
                        </div>
                        <div class="card-body py-2">
                            <table class="table table-sm table-borderless mb-0" style="font-size:12px;">
                                <tr>
                                    <td style="width:30px;"><i class="fas fa-hashtag text-muted"></i></td>
                                    <td>ID: <strong><?= (int)$row['id'] ?></strong></td>
                                </tr>
                                <tr>
                                    <td><i class="fas fa-link text-muted"></i></td>
                                    <td>URL: <code><?= htmlspecialchars($row['url']) ?></code></td>
                                </tr>
                                <tr>
                                    <td><i class="fas fa-palette text-muted"></i></td>
                                    <td>Icon: <code><?= htmlspecialchars($row['icon']) ?></code></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div class="card mt-3">
                        ...
                        <div class="card-body py-2">
                            <ul class="pl-3 mb-0" style="font-size:12px;line-height:2;">
                                ...
                                <li>Klik tombol <i class="fas fa-icons"></i> untuk pilih icon</li>
                                <li>Perubahan URL tidak mengubah file yang sudah dibuat</li>
                            </ul>
                        </div>
                    </div>
                </div>
